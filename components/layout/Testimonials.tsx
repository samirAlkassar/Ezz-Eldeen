...
const Testimonials = () => {
    return (
        <div className="overflow-hidden relative h-220 md:h-150 flex items-center justify-center flex-col">
            ...
            <div className="max-w-5xl mx-auto py-12 grid md:grid-cols-3 grid-cols-1 gap-12 md:gap-8 mt-2 md:mt-12 px-4 md:px-6">
                {
...
const TestimonialsCard = ({name, testimonial, rating, location, id}: {name: string, testimonial: string, rating: number, location: string | null, id: number}) => {
    return (
        <motion.div 
            ...
            className={twMerge("bg-white rounded-lg md:rounded-xl px-4 py-6 border-1 border-gray-200 shadow-md max-w-sm", id === 2 ? "z-20" : "z-10")}>
            <img src="./images/login-splash.jpg" alt="" className="h-10 w-10 md:h-14 md:w-14 rounded-full object-cover -mt-10 md:-mt-14 border-1 border-gray-800"/>
