...
const Testimonials = () => {
    ...
    return (
        <div className="overflow-hidden relative py-12 px-4 flex items-center justify-center flex-col bg-[#F8F7F5]">
            <p className="text-primary uppercase text-sm md:text-base tracking-[1.4px] leading-5 font-bold">{t("hero.testimonials.communityStories")}</p>
            ...
            <span className="flex gap-1 items-center justify-center mt-3 text-text-brown/80">
                <p className="text-xs md:text-sm">{t("hero.testimonials.ctaDescribtion")}</p>
