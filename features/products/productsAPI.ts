...
export async function getProductsApi(filters: any, lang: typeLang): Promise<ProductsResponse> {
...
export async function getProductBySlugApi(slug: string, lang: typeLang): Promise<ProductType> {
...
export async function addReviewApi(productId: string, reviewData: ReviewData, lang: typeLang): Promise<ProductType> {
