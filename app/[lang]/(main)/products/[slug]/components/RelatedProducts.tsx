    ...
    return (
        <div className="mt-30 md:mt-20 lg:mt-30">
            <div className="flex justify-between items-start">
                ...
                <button className="bg-black rounded-full py-2 md:py-3 px-4 md:px-8 text-white text-sm sm:text-base md:text-lg cursor-pointer">{t("similarProducts.showMore")}</button>
            </div>
